...
// RUN: %klee --output-dir=%t.klee-out1 --do-backward-first --write-to-db %t.bc 2> %t.log1
// RUN: %klee -debug-print-escaping-functions --output-dir=%t.klee-out2 --do-backward-first --write-to-db --summary-db=%t.klee-out1/summary.sqlite3 %t.bc 2> %t.log2
