...
// RUN: %klee --output-dir=%t.klee-out1 --execution-mode=forward --write-to-db --write-no-tests --exit-on-error %t1.bc
// RUN: %klee --output-dir=%t.klee-out2 --execution-mode=forward --write-to-db --write-no-tests --summary-db=%t.klee-out1/summary.sqlite3 --exit-on-error %t1.bc
