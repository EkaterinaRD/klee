...
; RUN: %klee --output-dir=%t.klee-out1 --optimize=false --write-to-db %t1.bc
; RUN: %klee --output-dir=%t.klee-out2 --optimize=false --write-to-db --summary-db=%t.klee-out1/summary.sqlite3 %t1.bc
