...
; RUN: %klee --output-dir=%t.klee-out1 --do-backward-first --optimize=false --write-to-db %t1.bc > %t2
; RUN: %klee --output-dir=%t.klee-out2 --do-backward-first --optimize=false --write-to-db --summary-db=%t.klee-out1/summary.sqlite3 %t1.bc > %t3
; RUN: grep PASS %t3
