...
// RUN: %klee --output-dir=%t.klee-out1 -use-cex-cache=1 -check-overshift=0 --write-to-db %t.bc
// RUN: %klee --output-dir=%t.klee-out2 -use-cex-cache=1 -check-overshift=0 --write-to-db --summary-db=%t.klee-out1/summary.sqlite3 %t.bc
