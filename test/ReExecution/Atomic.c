...
// RUN: %klee --output-dir=%t.klee-out1 --do-backward-first --exit-on-error --write-to-db %t.bc 2>%t.log1
// RUN: %klee --output-dir=%t.klee-out2 --do-backward-first --exit-on-error --write-to-db --summary-db=%t.klee-out1/summary.sqlite3 %t.bc 2>%t.log2
